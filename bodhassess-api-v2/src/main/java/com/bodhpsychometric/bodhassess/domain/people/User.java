 ...
 * respondent silos fold in at migration). Profile fields are merged in from
 * the legacy user_meta.
 *
 * dob is the portal credential by product decision — typed as a real date,
 * compared by the auth service. superAdmin deliberately sits above the role
 * system and overrides all permission checks.
 *
...
@Entity
@Table(name = "User",
        uniqueConstraints = @UniqueConstraint(name = "uqUserEmail", columnNames = "email"))

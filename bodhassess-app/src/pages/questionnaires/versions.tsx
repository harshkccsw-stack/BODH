 ...
 *
 * The editor itself reuses the existing /question-bank/create-questionnaire
 * page; we link to it with ?draftId=… so it loads against a specific
 * draft row.
 */
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              <Button
                ...
                onClick={() => {
                  ...
                  window.location.href = `/question-bank/create-questionnaire?${params.toString()}`;
                }}
              >
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4" onClick={() => !saving && onClose()}>
      <Card className="w-full max-w-md" onClick={(e) => e.stopPropagation()}>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="text-base">Commit version</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <label className="flex items-center gap-2 text-sm">
            ...
            <span>Set as current version (defaults new assessments to this)</span>
          </label>

        ...
        <div className="container grow space-y-5">
          <Toolbar>
            <ToolbarHeading>
              ...
              <ToolbarDescription>Manage your feed preferences and filters</ToolbarDescription>
            </ToolbarHeading>
            <ToolbarActions>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" className="hover:[&_[data-slot=badge]]:bg-accent-foreground/10 data-[state=open]:[&_[data-slot=badge]]:bg-accent-foreground/10">

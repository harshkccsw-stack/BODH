import {
  require_react_dom
} from "./chunk-N7U4VGEZ.js";
import {
  require_jsx_runtime
} from "./chunk-PP7TQJHG.js";
import {
  require_react
} from "./chunk-B3QV3APU.js";
import {
  __commonJS,
  __export,
  __toESM
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React105 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React105.useState, useEffect40 = React105.useEffect, useLayoutEffect6 = React105.useLayoutEffect, useDebugValue = React105.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var Collapsible = React15.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeCollapsible,
      open: openProp,
...
var CollapsibleTrigger = React15.forwardRef(
  (props, forwardedRef) => {
...
var CollapsibleContent = React15.forwardRef(
  (props, forwardedRef) => {
    const { forceMount, ...contentProps } = props;
    const context = useCollapsibleContext(CONTENT_NAME, props.__scopeCollapsible);
    return (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => (0, import_jsx_runtime10.jsx)(CollapsibleContentImpl, { ...contentProps, ref: forwardedRef, present }) });
  }
);
CollapsibleContent.displayName = CONTENT_NAME;
var CollapsibleContentImpl = React15.forwardRef((props, forwardedRef) => {
  const { __scopeCollapsible, present, children, ...contentProps } = props;
  const context = useCollapsibleContext(CONTENT_NAME, __scopeCollapsible);
  const [isPresent, setIsPresent] = React15.useState(present);
  const ref = React15.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const heightRef = React15.useRef(0);
  const height = heightRef.current;
  const widthRef = React15.useRef(0);
  const width = widthRef.current;
  const isOpen = context.open || isPresent;
  const isMountAnimationPreventedRef = React15.useRef(isOpen);
  const originalStylesRef = React15.useRef(void 0);
  React15.useEffect(() => {
...
var DirectionProvider = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(DirectionContext.Provider, { value: dir, children });
};
...
var Accordion = import_react3.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(Collection.Provider, { scope: props.__scopeAccordion, children: type === "multiple" ? (0, import_jsx_runtime12.jsx)(AccordionImplMultiple, { ...multipleProps, ref: forwardedRef }) : (0, import_jsx_runtime12.jsx)(AccordionImplSingle, { ...singleProps, ref: forwardedRef }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(
      AccordionValueProvider,
      {
        ...
        children: (0, import_jsx_runtime12.jsx)(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible, children: (0, import_jsx_runtime12.jsx)(AccordionImpl, { ...accordionSingleProps, ref: forwardedRef }) })
      }
    );
  }
);
var AccordionImplMultiple = import_react3.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime12.jsx)(
    AccordionValueProvider,
    {
      ...
      children: (0, import_jsx_runtime12.jsx)(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible: true, children: (0, import_jsx_runtime12.jsx)(AccordionImpl, { ...accordionMultipleProps, ref: forwardedRef }) })
    }
  );
});
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(
      AccordionImplProvider,
      {
        ...
        direction: dir,
        orientation,
        children: (0, import_jsx_runtime12.jsx)(Collection.Slot, { scope: __scopeAccordion, children: (0, import_jsx_runtime12.jsx)(
          Primitive2.div,
          {
            ...accordionProps,
...
var AccordionTrigger = import_react3.default.forwardRef(
  (props, forwardedRef) => {
    ...
    const collapsibleScope = useCollapsibleScope(__scopeAccordion);
    return (0, import_jsx_runtime12.jsx)(Collection.ItemSlot, { scope: __scopeAccordion, children: (0, import_jsx_runtime12.jsx)(
      Trigger,
      {
...
var DismissableLayerBranch = React21.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime14.jsx)(Primitive4.div, { ...props, ref: composedRefs });
});
...
var FocusScope = React26.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime16.jsx)(Primitive5.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var Portal = React28.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom.default.createPortal((0, import_jsx_runtime18.jsx)(Primitive6.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime20.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React40.Children.map(children, (child) => (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime20.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlay = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime20.jsx)(DialogOverlayImpl, { ...overlayProps, ref: forwardedRef }) }) : null;
  }
);
...
var DialogOverlayImpl = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime20.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime20.jsx)(
        Primitive7.div,
        {
          "data-state": getState3(context.open),
          ...overlayProps,
...
var DialogContent = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime20.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime20.jsx)(DialogContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime20.jsx)(DialogContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var DialogContentImpl = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
      ...
      (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
        (0, import_jsx_runtime20.jsx)(TitleWarning, { titleId: context.titleId }),
        (0, import_jsx_runtime20.jsx)(DescriptionWarning, { contentRef, descriptionId: context.descriptionId })
      ] })
    ] });
  }
);
...
var DialogTitle = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime20.jsx)(Primitive7.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
...
var DialogDescription = React40.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime20.jsx)(Primitive7.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime21.jsx)(Root6, { ...dialogScope, ...alertDialogProps, modal: true });
};
AlertDialog.displayName = ROOT_NAME;
var TRIGGER_NAME4 = "AlertDialogTrigger";
var AlertDialogTrigger = React41.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...triggerProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime21.jsx)(Trigger3, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
...
var AlertDialogPortal = (props) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime21.jsx)(Portal2, { ...dialogScope, ...portalProps });
};
AlertDialogPortal.displayName = PORTAL_NAME3;
var OVERLAY_NAME2 = "AlertDialogOverlay";
var AlertDialogOverlay = React41.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...overlayProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime21.jsx)(Overlay, { ...dialogScope, ...overlayProps, ref: forwardedRef });
  }
);
...
var AlertDialogContent = React41.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, children, ...contentProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const contentRef = React41.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const cancelRef = React41.useRef(null);
    return (0, import_jsx_runtime21.jsx)(
      WarningProvider,
      {
        ...
        children: (0, import_jsx_runtime21.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime21.jsxs)(
          Content3,
          {
            role: "alertdialog",
            ...dialogScope,
            ...
            children: [
              (0, import_jsx_runtime21.jsx)(Slottable2, { children }),
              (0, import_jsx_runtime21.jsx)(DescriptionWarning2, { contentRef })
            ]
          }
        ) })
      }
...
var AlertDialogTitle = React41.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...titleProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime21.jsx)(Title, { ...dialogScope, ...titleProps, ref: forwardedRef });
  }
);
AlertDialogTitle.displayName = TITLE_NAME2;
var DESCRIPTION_NAME2 = "AlertDialogDescription";
var AlertDialogDescription = React41.forwardRef((props, forwardedRef) => {
  const { __scopeAlertDialog, ...descriptionProps } = props;
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime21.jsx)(Description, { ...dialogScope, ...descriptionProps, ref: forwardedRef });
});
AlertDialogDescription.displayName = DESCRIPTION_NAME2;
var ACTION_NAME = "AlertDialogAction";
var AlertDialogAction = React41.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...actionProps } = props;
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime21.jsx)(Close, { ...dialogScope, ...actionProps, ref: forwardedRef });
  }
);
AlertDialogAction.displayName = ACTION_NAME;
var CANCEL_NAME = "AlertDialogCancel";
var AlertDialogCancel = React41.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAlertDialog, ...cancelProps } = props;
    const { cancelRef } = useAlertDialogContentContext(CANCEL_NAME, __scopeAlertDialog);
    const dialogScope = useDialogScope(__scopeAlertDialog);
    const ref = useComposedRefs(forwardedRef, cancelRef);
    return (0, import_jsx_runtime21.jsx)(Close, { ...dialogScope, ...cancelProps, ref });
  }
);
...
var AspectRatio = React43.forwardRef(
  (props, forwardedRef) => {
...
var Avatar = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React45.useState("idle");
    return (0, import_jsx_runtime25.jsx)(
      AvatarProvider,
      {
        ...
        children: (0, import_jsx_runtime25.jsx)(Primitive9.span, { ...avatarProps, ref: forwardedRef })
      }
    );
  }
);
...
var AvatarImage = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return imageLoadingStatus === "loaded" ? (0, import_jsx_runtime25.jsx)(Primitive9.img, { ...imageProps, ref: forwardedRef, src }) : null;
  }
);
AvatarImage.displayName = IMAGE_NAME;
var FALLBACK_NAME = "AvatarFallback";
var AvatarFallback = React45.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React45.useState(delayMs === void 0);
    React45.useEffect(() => {
      if (delayMs !== void 0) {
    ...
    return canRender && context.imageLoadingStatus !== "loaded" ? (0, import_jsx_runtime25.jsx)(Primitive9.span, { ...fallbackProps, ref: forwardedRef }) : null;
  }
);
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const imageRef = React45.useRef(null);
  const image = (() => {
  ...
  const [loadingStatus, setLoadingStatus] = React45.useState(
...
function useSize(element) {
  const [size4, setSize] = React47.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var Primitive10 = NODES10.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React48.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React49.useState(null);
  const [bubbleInput, setBubbleInput] = React49.useState(null);
...
var CheckboxTrigger = React49.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = React49.useRef(checked);
    React49.useEffect(() => {
...
var CheckboxIndicator = React49.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = React49.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React49.useRef(isIndeterminate(checked) ? false : checked);
    return (0, import_jsx_runtime27.jsx)(
      Primitive10.input,
      {
        type: "checkbox",
...
var Primitive11 = NODES11.reduce((primitive, node) => {
  ...
  const Node2 = React50.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime28.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var NAME4 = "Arrow";
var Arrow = React53.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime30.jsx)(
    Primitive12.svg,
    {
      ...
      children: props.asChild ? children : (0, import_jsx_runtime30.jsx)("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
var Popper = (props) => {
  ...
  return (0, import_jsx_runtime32.jsx)(PopperProvider, { scope: __scopePopper, anchor, onAnchorChange: setAnchor, children });
};
...
var PopperAnchor = React55.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime32.jsx)(Primitive13.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var PopperContent = React55.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow4, setArrow] = React55.useState(null);
...
var Primitive14 = NODES14.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React56.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function dispatchDiscreteCustomEvent2(target, event) {
  if (target) ReactDOM16.flushSync(() => target.dispatchEvent(event));
}
...
var Primitive15 = NODES15.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React57.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var MenuGroup = React59.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(Primitive14.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React59.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(Primitive14.div, { ...labelProps, ref: forwardedRef });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(
      Collection3.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime36.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime36.jsx)(
          Primitive14.div,
          {
            role: "menuitem",
...
var ContextMenuItem = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime37.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime39.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime39.jsx)(Root32, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
DropdownMenu.displayName = DROPDOWN_MENU_NAME;
var TRIGGER_NAME7 = "DropdownMenuTrigger";
var DropdownMenuTrigger = React62.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, disabled = false, ...triggerProps } = props;
    const context = useDropdownMenuContext(TRIGGER_NAME7, __scopeDropdownMenu);
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime39.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime39.jsx)(
      Primitive16.button,
      {
        type: "button",
...
var DropdownMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime39.jsx)(Portal3, { ...menuScope, ...portalProps });
};
DropdownMenuPortal.displayName = PORTAL_NAME6;
var CONTENT_NAME8 = "DropdownMenuContent";
var DropdownMenuContent = React62.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React62.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...groupProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime39.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }
);
DropdownMenuGroup.displayName = GROUP_NAME4;
var LABEL_NAME3 = "DropdownMenuLabel";
var DropdownMenuLabel = React62.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...labelProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime39.jsx)(Label, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
DropdownMenuLabel.displayName = LABEL_NAME3;
var ITEM_NAME5 = "DropdownMenuItem";
var DropdownMenuItem = React62.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime39.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
DropdownMenuItem.displayName = ITEM_NAME5;
var CHECKBOX_ITEM_NAME3 = "DropdownMenuCheckboxItem";
var DropdownMenuCheckboxItem = React62.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime39.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
});
DropdownMenuCheckboxItem.displayName = CHECKBOX_ITEM_NAME3;
var RADIO_GROUP_NAME3 = "DropdownMenuRadioGroup";
var DropdownMenuRadioGroup = React62.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime39.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
});
DropdownMenuRadioGroup.displayName = RADIO_GROUP_NAME3;
var RADIO_ITEM_NAME3 = "DropdownMenuRadioItem";
var DropdownMenuRadioItem = React62.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime39.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
});
DropdownMenuRadioItem.displayName = RADIO_ITEM_NAME3;
var INDICATOR_NAME3 = "DropdownMenuItemIndicator";
var DropdownMenuItemIndicator = React62.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime39.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
});
DropdownMenuItemIndicator.displayName = INDICATOR_NAME3;
var SEPARATOR_NAME3 = "DropdownMenuSeparator";
var DropdownMenuSeparator = React62.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...separatorProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime39.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
});
DropdownMenuSeparator.displayName = SEPARATOR_NAME3;
var ARROW_NAME4 = "DropdownMenuArrow";
var DropdownMenuArrow = React62.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime39.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var DropdownMenuSub = (props) => {
  ...
  return (0, import_jsx_runtime39.jsx)(Sub, { ...menuScope, open, onOpenChange: setOpen, children });
};
var SUB_TRIGGER_NAME3 = "DropdownMenuSubTrigger";
var DropdownMenuSubTrigger = React62.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime39.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
});
DropdownMenuSubTrigger.displayName = SUB_TRIGGER_NAME3;
var SUB_CONTENT_NAME3 = "DropdownMenuSubContent";
var DropdownMenuSubContent = React62.forwardRef((props, forwardedRef) => {
...
var Primitive17 = NODES17.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React63.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var NAME5 = "Label";
var Label3 = React64.forwardRef((props, forwardedRef) => {
...
var Form = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const formRef = React66.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React66.useState({});
    const getFieldValidity = React66.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React66.useCallback(
    ...
    const handleFieldValiditionClear = React66.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React66.useState({});
    const getFieldCustomMatcherEntries = React66.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React66.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React66.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React66.useState({});
    const getFieldCustomErrors = React66.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React66.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React66.useState({});
    const handleFieldMessageIdAdd = React66.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React66.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React66.useCallback(
...
var FormField = React66.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, name, serverInvalid = false, ...fieldProps } = props;
    const validationContext = useValidationContext(FIELD_NAME, __scopeForm);
    const validity = validationContext.getFieldValidity(name);
    const id = useId();
    return (0, import_jsx_runtime43.jsx)(FormFieldProvider, { scope: __scopeForm, id, name, serverInvalid, children: (0, import_jsx_runtime43.jsx)(
      Primitive18.div,
      {
...
var FormControl = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React66.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React66.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React66.forwardRef(
  (props, forwardedRef) => {
    const { match, name: nameProp, ...messageProps } = props;
    const fieldContext = useFormFieldContext(MESSAGE_NAME, props.__scopeForm);
    const name = nameProp ?? fieldContext.name;
    if (match === void 0) {
      return (0, import_jsx_runtime43.jsx)(FormMessageImpl, { ...messageProps, ref: forwardedRef, name, children: props.children || DEFAULT_INVALID_MESSAGE });
    } else if (typeof match === "function") {
      return (0, import_jsx_runtime43.jsx)(FormCustomMessage, { match, ...messageProps, ref: forwardedRef, name });
    } else {
      return (0, import_jsx_runtime43.jsx)(FormBuiltInMessage, { match, ...messageProps, ref: forwardedRef, name });
    }
  }
);
FormMessage.displayName = MESSAGE_NAME;
var FormBuiltInMessage = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime43.jsx)(FormMessageImpl, { ref: forwardedRef, ...messageProps, name, children: children ?? DEFAULT_BUILT_IN_MESSAGES[match] });
    }
    return null;
  }
);
var FormCustomMessage = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React66.useMemo(() => ({ id, match }), [id, match]);
    ...
    if (matches) {
      return (0, import_jsx_runtime43.jsx)(FormMessageImpl, { id, ref: composedRef, ...messageProps, name, children: children ?? DEFAULT_INVALID_MESSAGE });
    }
    return null;
  }
);
var FormMessageImpl = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime43.jsx)(Primitive18.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormValidityState = (props) => {
  ...
  const name = nameProp ?? fieldContext.name;
  const validity = validationContext.getFieldValidity(name);
  return (0, import_jsx_runtime43.jsx)(import_jsx_runtime43.Fragment, { children: children(validity) });
};
FormValidityState.displayName = VALIDITY_STATE_NAME;
var SUBMIT_NAME = "FormSubmit";
var FormSubmit = React66.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, ...submitProps } = props;
    return (0, import_jsx_runtime43.jsx)(Primitive18.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
var Primitive19 = NODES19.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React67.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var HoverCard = (props) => {
  ...
  return (0, import_jsx_runtime45.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime45.jsx)(Root24, { ...popperScope, children })
    }
  );
};
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime45.jsx)(PortalProvider3, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime45.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime45.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var HoverCardContent = React68.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime45.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime45.jsx)(
...
var HoverCardArrow = React68.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope2(__scopeHoverCard);
    return (0, import_jsx_runtime45.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Menubar = React70.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React70.useState(null);
    return (0, import_jsx_runtime47.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React70.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React70.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React70.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime47.jsx)(Collection4.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime47.jsx)(Collection4.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime47.jsx)(
          Root10,
          {
            asChild: true,
            ...rovingFocusGroupScope,
            ...
            children: (0, import_jsx_runtime47.jsx)(Primitive20.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React70.useRef(false);
...
var MenubarTrigger = React70.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime47.jsx)(Collection4.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime47.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime47.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime47.jsx)(
          Primitive20.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarPortal = (props) => {
  ...
  const menuScope = useMenuScope3(__scopeMenubar);
  return (0, import_jsx_runtime47.jsx)(Portal3, { ...menuScope, ...portalProps });
};
MenubarPortal.displayName = PORTAL_NAME8;
var CONTENT_NAME10 = "MenubarContent";
var MenubarContent = React70.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...groupProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime47.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }
);
MenubarGroup.displayName = GROUP_NAME5;
var LABEL_NAME5 = "MenubarLabel";
var MenubarLabel = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...labelProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime47.jsx)(Label, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
MenubarLabel.displayName = LABEL_NAME5;
var ITEM_NAME6 = "MenubarItem";
var MenubarItem = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...itemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime47.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
MenubarItem.displayName = ITEM_NAME6;
var CHECKBOX_ITEM_NAME4 = "MenubarCheckboxItem";
var MenubarCheckboxItem = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...checkboxItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime47.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
  }
);
MenubarCheckboxItem.displayName = CHECKBOX_ITEM_NAME4;
var RADIO_GROUP_NAME4 = "MenubarRadioGroup";
var MenubarRadioGroup = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...radioGroupProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime47.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
  }
);
MenubarRadioGroup.displayName = RADIO_GROUP_NAME4;
var RADIO_ITEM_NAME4 = "MenubarRadioItem";
var MenubarRadioItem = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...radioItemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime47.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
  }
);
MenubarRadioItem.displayName = RADIO_ITEM_NAME4;
var INDICATOR_NAME4 = "MenubarItemIndicator";
var MenubarItemIndicator = React70.forwardRef((props, forwardedRef) => {
  const { __scopeMenubar, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope3(__scopeMenubar);
  return (0, import_jsx_runtime47.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
});
MenubarItemIndicator.displayName = INDICATOR_NAME4;
var SEPARATOR_NAME4 = "MenubarSeparator";
var MenubarSeparator = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...separatorProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime47.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
  }
);
MenubarSeparator.displayName = SEPARATOR_NAME4;
var ARROW_NAME6 = "MenubarArrow";
var MenubarArrow = React70.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...arrowProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime47.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenubarSub = (props) => {
  ...
  return (0, import_jsx_runtime47.jsx)(Sub, { ...menuScope, open, onOpenChange: setOpen, children });
};
MenubarSub.displayName = SUB_NAME3;
var SUB_TRIGGER_NAME4 = "MenubarSubTrigger";
var MenubarSubTrigger = React70.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React70.forwardRef(
  (props, forwardedRef) => {
...
var Primitive21 = NODES21.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React71.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function dispatchDiscreteCustomEvent3(target, event) {
  if (target) ReactDOM23.flushSync(() => target.dispatchEvent(event));
}
...
var NavigationMenu = React72.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React72.useState(null);
    ...
    const [isOpenDelayed, setIsOpenDelayed] = React72.useState(true);
    const [value, setValue] = useControllableState({
      prop: valueProp,
      onChange: (value2) => {
        const isOpen = value2 !== "";
    ...
    const startCloseTimer = React72.useCallback(() => {
...
var NavigationMenuSub = React72.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
    ...
    return (0, import_jsx_runtime49.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime49.jsx)(Primitive21.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React72.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React72.useState(null);
  return (0, import_jsx_runtime49.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React72.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React72.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
      ...
      children: (0, import_jsx_runtime49.jsx)(Collection5.Provider, { scope, children: (0, import_jsx_runtime49.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
var LIST_NAME = "NavigationMenuList";
var NavigationMenuList = React72.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...listProps } = props;
    const context = useNavigationMenuContext(LIST_NAME, __scopeNavigationMenu);
    const list = (0, import_jsx_runtime49.jsx)(Primitive21.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime49.jsx)(Primitive21.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime49.jsx)(Collection5.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime49.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
...
var NavigationMenuItem = React72.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React72.useRef(null);
    const restoreContentTabOrderRef = React72.useRef(() => {
    });
    const wasEscapeCloseRef = React72.useRef(false);
    const handleContentEntry = React72.useCallback((side = "start") => {
    ...
    const handleContentExit = React72.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates2(contentRef.current);
    ...
    return (0, import_jsx_runtime49.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime49.jsx)(Primitive21.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React72.forwardRef((props, forwardedRef) => {
  ...
  const wasClickCloseRef = React72.useRef(false);
  const open = itemContext.value === context.value;
  return (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [
    (0, import_jsx_runtime49.jsx)(Collection5.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime49.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime49.jsx)(
      Primitive21.button,
      {
        id: triggerId,
        disabled,
...
var NavigationMenuLink = React72.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicator = React72.forwardRef((props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React72.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React72.useState(
    null
  );
  const [position, setPosition] = React72.useState(null);
...
var NavigationMenuContent = React72.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React72.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React72.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React72.useRef(null);
  ...
  const motionAttribute = React72.useMemo(() => {
    const items = getItems();
...
var NavigationMenuViewport = React72.forwardRef((props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React72.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React72.useState(null);
...
var FocusGroup = React72.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const context = useNavigationMenuContext(FOCUS_GROUP_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime49.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime49.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime49.jsx)(Primitive21.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
var ARROW_KEYS = ["ArrowRight", "ArrowLeft", "ArrowUp", "ArrowDown"];
var FOCUS_GROUP_ITEM_NAME = "FocusGroupItem";
var FocusGroupItem = React72.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
var Primitive22 = NODES22.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React73.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var OneTimePasswordField = React74.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React74.useCallback(
      (value2) => {
    ...
    const controlledValue = React74.useMemo(() => {
    ...
    const validationTypeRef = React74.useRef(validation);
    React74.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React74.useRef(null);
    const userActionRef = React74.useRef(null);
    ...
    const locateForm = React74.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React74.useCallback(() => {
    ...
    const valueRef = React74.useRef(currentValue);
    ...
    return (0, import_jsx_runtime51.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime51.jsx)(Collection6.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime51.jsx)(Collection6.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime51.jsx)(
          Root10,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React74.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React74.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React74.useState(null);
  ...
  const keyboardActionTimeoutRef = React74.useRef(null);
  React74.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime51.jsx)(Collection6.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime51.jsx)(
    Item2,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React76.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React76.useCallback(
  ...
  const focusState = React76.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React76.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React76.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React76.useState(void 0);
    const elementRef = React76.useRef(null);
...
var PasswordToggleFieldIcon = React76.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime53.jsx)(Primitive23.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
var Primitive24 = NODES24.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React77.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Popover = (props) => {
  ...
  return (0, import_jsx_runtime55.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime55.jsx)(
    PopoverProvider,
    {
...
var PopoverAnchor = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime55.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var PopoverTrigger = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
    const trigger = (0, import_jsx_runtime55.jsx)(
      Primitive24.button,
      {
        type: "button",
        "aria-haspopup": "dialog",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime55.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime55.jsx)(PortalProvider4, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime55.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime55.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime55.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime55.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime55.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime55.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime55.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverArrow = React78.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime55.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var Primitive25 = NODES25.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React79.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
var Progress = React80.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
    ...
    return (0, import_jsx_runtime57.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, children: (0, import_jsx_runtime57.jsx)(
      Primitive25.div,
      {
        "aria-valuemax": max2,
        "aria-valuemin": 0,
...
var ProgressIndicator = React80.forwardRef(
  (props, forwardedRef) => {
...
var Primitive26 = NODES26.reduce((primitive, node) => {
  ...
  const Node2 = React81.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime58.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Radio = React82.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime59.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
      ...
      isFormControl2 && (0, import_jsx_runtime59.jsx)(
        RadioBubbleInput,
        {
          control: button,
...
var RadioIndicator = React82.forwardRef(
  (props, forwardedRef) => {
    const { __scopeRadio, forceMount, ...indicatorProps } = props;
    const context = useRadioContext(INDICATOR_NAME7, __scopeRadio);
    return (0, import_jsx_runtime59.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime59.jsx)(
      Primitive26.span,
      {
...
var RadioBubbleInput = React82.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var RadioGroupIndicator = React210.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime60.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
...
var Primitive27 = NODES27.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React83.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime61.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
function useStateMachine2(initialState, machine) {
  return React84.useReducer((state, event) => {
    const nextState = machine[state][event];
    return nextState ?? state;
  }, initialState);
}
    ...
    return (0, import_jsx_runtime62.jsxs)(import_jsx_runtime62.Fragment, { children: [
      ...
      (0, import_jsx_runtime62.jsx)(
        Primitive27.div,
        {
          ...
          children: (0, import_jsx_runtime62.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaScrollbar = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime62.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime62.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime62.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime62.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime62.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime62.jsx)(
...
var ScrollAreaScrollbarScroll = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime62.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime62.jsx)(
...
var ScrollAreaThumb = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime62.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime62.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime62.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React211.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime62.jsx)(
    Primitive27.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
var Primitive28 = NODES28.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React85.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime63.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Select = (props) => {
  ...
  const [trigger, setTrigger] = React86.useState(null);
  const [valueNode, setValueNode] = React86.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React86.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React86.useRef(null);
  const isFormControl2 = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React86.useState(/* @__PURE__ */ new Set());
  const nativeSelectKey = Array.from(nativeOptionsSet).map((option) => option.props.value).join(";");
  return (0, import_jsx_runtime64.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime64.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime64.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime64.jsx)(
          SelectNativeOptionsProvider,
          {
            scope: props.__scopeSelect,
            onNativeOptionAdd: React86.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React86.useCallback((option) => {
        ...
        isFormControl2 ? (0, import_jsx_runtime64.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime64.jsx)("option", { value: "" }) : null,
...
var SelectTrigger = React86.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React86.useRef("touch");
    ...
    return (0, import_jsx_runtime64.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime64.jsx)(
      Primitive28.button,
      {
        type: "button",
        role: "combobox",
...
var SelectValue = React86.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime64.jsx)(
      Primitive28.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime64.jsx)(import_jsx_runtime64.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React86.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, children, ...iconProps } = props;
    return (0, import_jsx_runtime64.jsx)(Primitive28.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME10 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime64.jsx)(Portal, { asChild: true, ...props });
};
SelectPortal.displayName = PORTAL_NAME10;
var CONTENT_NAME13 = "SelectContent";
var SelectContent = React86.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React86.useState();
    useLayoutEffect2(() => {
      setFragment(new DocumentFragment());
    }, []);
    if (!context.open) {
      const frag = fragment;
      return frag ? ReactDOM32.createPortal(
        (0, import_jsx_runtime64.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime64.jsx)(Collection7.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime64.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime64.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
...
var SelectContentImpl = React86.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [content, setContent] = React86.useState(null);
    const [viewport, setViewport] = React86.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React86.useState(null);
    const [selectedItemText, setSelectedItemText] = React86.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React86.useState(false);
    const firstValidItemFoundRef = React86.useRef(false);
    React86.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React86.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React86.useCallback(
    ...
    const itemRefCallback = React86.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React86.useCallback(() => content?.focus(), [content]);
    const itemTextRefCallback = React86.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
    ...
    return (0, import_jsx_runtime64.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime64.jsx)(Combination_default, { as: Slot5, allowPinchZoom: true, children: (0, import_jsx_runtime64.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectItemAlignedPosition = React86.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React86.useState(null);
  const [content, setContent] = React86.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React86.useRef(false);
  const shouldRepositionRef = React86.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React86.useCallback(() => {
  ...
  const [contentZIndex, setContentZIndex] = React86.useState();
  useLayoutEffect2(() => {
    if (content) setContentZIndex(window.getComputedStyle(content).zIndex);
  }, [content]);
  const handleScrollButtonChange = React86.useCallback(
    (node) => {
...
var SelectPopperPosition = React86.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React86.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React86.useRef(0);
    return (0, import_jsx_runtime64.jsxs)(import_jsx_runtime64.Fragment, { children: [
      ...
      (0, import_jsx_runtime64.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime64.jsx)(
        Primitive28.div,
        {
...
var SelectGroup = React86.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...groupProps } = props;
    const groupId = useId();
    return (0, import_jsx_runtime64.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime64.jsx)(Primitive28.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
SelectGroup.displayName = GROUP_NAME6;
var LABEL_NAME6 = "SelectLabel";
var SelectLabel = React86.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...labelProps } = props;
    const groupContext = useSelectGroupContext(LABEL_NAME6, __scopeSelect);
    return (0, import_jsx_runtime64.jsx)(Primitive28.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItem = React86.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React86.useState(textValueProp ?? "");
    const [isFocused, setIsFocused] = React86.useState(false);
    ...
    return (0, import_jsx_runtime64.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React86.useCallback((node) => {
...
var SelectItemText = React86.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React86.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React86.useMemo(
      () => (0, import_jsx_runtime64.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime64.jsxs)(import_jsx_runtime64.Fragment, { children: [
      (0, import_jsx_runtime64.jsx)(Primitive28.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
      itemContext.isSelected && context.valueNode && !context.valueNodeHasChildren ? ReactDOM32.createPortal(itemTextProps.children, context.valueNode) : null
    ] });
  }
);
SelectItemText.displayName = ITEM_TEXT_NAME;
var ITEM_INDICATOR_NAME2 = "SelectItemIndicator";
var SelectItemIndicator = React86.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...itemIndicatorProps } = props;
    const itemContext = useSelectItemContext(ITEM_INDICATOR_NAME2, __scopeSelect);
    return itemContext.isSelected ? (0, import_jsx_runtime64.jsx)(Primitive28.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
SelectItemIndicator.displayName = ITEM_INDICATOR_NAME2;
var SCROLL_UP_BUTTON_NAME = "SelectScrollUpButton";
var SelectScrollUpButton = React86.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React86.useState(false);
  ...
  return canScrollUp ? (0, import_jsx_runtime64.jsx)(
...
var SelectScrollDownButton = React86.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React86.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
  ...
  return canScrollDown ? (0, import_jsx_runtime64.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectScrollButtonImpl = React86.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React86.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React86.useCallback(() => {
...
var SelectSeparator = React86.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...separatorProps } = props;
    return (0, import_jsx_runtime64.jsx)(Primitive28.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
SelectSeparator.displayName = SEPARATOR_NAME5;
var ARROW_NAME8 = "SelectArrow";
var SelectArrow = React86.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime64.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
SelectArrow.displayName = ARROW_NAME8;
var BUBBLE_INPUT_NAME3 = "SelectBubbleInput";
var SelectBubbleInput = React86.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React86.useRef("");
  const timerRef = React86.useRef(0);
  const handleTypeaheadSearch = React86.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React86.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React86.useEffect(() => {
...
var ReactDOM33 = __toESM(require_react_dom(), 1);
...
var Primitive29 = NODES29.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React87.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime65.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Separator4 = React88.forwardRef((props, forwardedRef) => {
...
var ReactDOM34 = __toESM(require_react_dom(), 1);
...
var Primitive30 = NODES30.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React89.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime67.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Slider = React90.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React90.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React90.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React90.useRef(values);
    ...
    return (0, import_jsx_runtime68.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime68.jsx)(Collection8.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime68.jsx)(Collection8.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime68.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React90.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React90.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React90.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React90.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
...
var SliderImpl = React90.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React90.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React90.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React90.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React90.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index2 = React90.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime68.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index: index2 });
  }
);
var SliderThumbImpl = React90.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime68.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime68.jsx)(Collection8.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime68.jsx)(
            Primitive30.span,
            {
              role: "slider",
          ...
          isFormControl2 && (0, import_jsx_runtime68.jsx)(
            SliderBubbleInput,
            {
...
var SliderBubbleInput = React90.forwardRef(
...
var ReactDOM35 = __toESM(require_react_dom(), 1);
...
var Primitive31 = NODES31.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React91.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime69.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Switch = React92.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React92.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React92.useRef(false);
    const isFormControl2 = button ? form || !!button.closest("form") : true;
    const [checked, setChecked] = useControllableState({
      prop: checkedProp,
      defaultProp: defaultChecked ?? false,
    ...
    return (0, import_jsx_runtime70.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
      ...
      isFormControl2 && (0, import_jsx_runtime70.jsx)(
        SwitchBubbleInput,
        {
          control: button,
          bubbles: !hasConsumerStoppedPropagationRef.current,
...
var SwitchThumb = React92.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React92.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
var ReactDOM36 = __toESM(require_react_dom(), 1);
...
var Primitive32 = NODES32.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React93.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime71.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var TabsList = React94.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React94.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React94.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React94.useRef(isSelected);
    React94.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
    return (0, import_jsx_runtime72.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime72.jsx)(
      Primitive32.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
var Primitive33 = NODES33.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React95.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
...
function dispatchDiscreteCustomEvent4(target, event) {
  if (target) ReactDOM37.flushSync(() => target.dispatchEvent(event));
}
...
var ToastProvider = (props) => {
  ...
  const [viewport, setViewport] = React96.useState(null);
  const [toastCount, setToastCount] = React96.useState(0);
  const isFocusedToastEscapeKeyDownRef = React96.useRef(false);
  const isClosePausedRef = React96.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime74.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime74.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React96.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React96.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React96.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const wrapperRef = React96.useRef(null);
    const headFocusProxyRef = React96.useRef(null);
    const tailFocusProxyRef = React96.useRef(null);
    ...
    const getSortedTabbableCandidates = React96.useCallback(
      ({ tabbingDirection }) => {
    ...
    return (0, import_jsx_runtime74.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime74.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime74.jsx)(Collection9.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime74.jsx)(Primitive33.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime74.jsx)(
            FocusProxy,
            {
...
var FocusProxy = React96.forwardRef(
  (props, forwardedRef) => {
...
var Toast = React96.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime74.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime74.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React96.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React96.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React96.useRef(null);
    const swipeDeltaRef = React96.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React96.useRef(0);
    const closeTimerRemainingTimeRef = React96.useRef(duration);
    const closeTimerRef = React96.useRef(0);
    ...
    const startTimer = React96.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React96.useMemo(() => {
      return node ? getAnnounceTextContent(node) : null;
    }, [node]);
    if (!context.viewport) return null;
    return (0, import_jsx_runtime74.jsxs)(import_jsx_runtime74.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime74.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime74.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM38.createPortal(
        (0, import_jsx_runtime74.jsx)(Collection9.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime74.jsx)(
          Root4,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React96.useState(false);
  const [isAnnounced, setIsAnnounced] = React96.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  React96.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : (0, import_jsx_runtime74.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime74.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime74.jsxs)(import_jsx_runtime74.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React96.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return (0, import_jsx_runtime74.jsx)(Primitive33.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME3;
var DESCRIPTION_NAME3 = "ToastDescription";
var ToastDescription = React96.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return (0, import_jsx_runtime74.jsx)(Primitive33.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME3;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React96.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime74.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime74.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.displayName = ACTION_NAME2;
var CLOSE_NAME3 = "ToastClose";
var ToastClose = React96.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME3, __scopeToast);
    return (0, import_jsx_runtime74.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime74.jsx)(
      Primitive33.button,
      {
        type: "button",
        ...closeProps,
...
var ToastAnnounceExclude = React96.forwardRef((props, forwardedRef) => {
...
function handleAndDispatchCustomEvent2(name, handler, detail, { discrete }) {
  ...
  if (discrete) {
    dispatchDiscreteCustomEvent4(currentTarget, event);
  } else {
...
var ReactDOM39 = __toESM(require_react_dom(), 1);
...
var Primitive34 = NODES34.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React97.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime75.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var NAME7 = "Toggle";
var Toggle = React98.forwardRef((props, forwardedRef) => {
...
var ReactDOM40 = __toESM(require_react_dom(), 1);
...
var Primitive35 = NODES35.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React99.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime77.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var ToggleGroup = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime78.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime78.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime78.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime78.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime78.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime78.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime78.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime78.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime78.jsx)(Primitive35.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime78.jsx)(Primitive35.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime78.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime78.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime78.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
var ReactDOM41 = __toESM(require_react_dom(), 1);
...
var Primitive36 = NODES36.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React101.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime79.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Toolbar = React102.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime80.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime80.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React102.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React102.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime80.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime80.jsx)(Primitive36.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React102.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime80.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime80.jsx)(
      Primitive36.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React102.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React102.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime80.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime80.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var ReactDOM42 = __toESM(require_react_dom(), 1);
...
var Primitive37 = NODES37.reduce((primitive, node) => {
  const Slot6 = createSlot(`Primitive.${node}`);
  const Node2 = React103.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot6 : node;
    if (typeof window !== "undefined") {
      window[/* @__PURE__ */ Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime81.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React104.useRef(true);
  const isPointerInTransitRef = React104.useRef(false);
  const skipDelayTimerRef = React104.useRef(0);
  React104.useEffect(() => {
  ...
  return (0, import_jsx_runtime82.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React104.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React104.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React104.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React104.useState(null);
  const contentId = useId();
  const openTimerRef = React104.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React104.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React104.useMemo(() => {
    return open ? wasOpenDelayedRef.current ? "delayed-open" : "instant-open" : "closed";
  }, [open]);
  const handleOpen = React104.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  const handleDelayedOpen = React104.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = window.setTimeout(() => {
  ...
  return (0, import_jsx_runtime82.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime82.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React104.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React104.useCallback(() => {
...
var TooltipTrigger = React104.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React104.useRef(false);
    const hasPointerMoveOpenedRef = React104.useRef(false);
    const handlePointerUp = React104.useCallback(() => isPointerDownRef.current = false, []);
    React104.useEffect(() => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime82.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime82.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime82.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME11;
var CONTENT_NAME15 = "TooltipContent";
var TooltipContent = React104.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime82.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime82.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime82.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React104.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React104.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React104.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React104.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React104.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime82.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable3 = createSlottable("TooltipContent");
var TooltipContentImpl = React104.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
    ...
    return (0, import_jsx_runtime82.jsx)(
      DismissableLayer,
      {
        ...
        onFocusOutside: (event) => event.preventDefault(),
        onDismiss: onClose,
        children: (0, import_jsx_runtime82.jsxs)(
          Content4,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              (0, import_jsx_runtime82.jsx)(Slottable3, { children }),
              (0, import_jsx_runtime82.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime82.jsx)(Root, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React104.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime82.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
